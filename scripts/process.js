...
[ "_malloc", "_memory", "_handle", "___indirect_function_table", "___asyncjs__weavedrive_open", "___asyncjs__weavedrive_read", "___asyncjs__weavedrive_close", "_main", "onRuntimeInitialized" ].forEach(prop => {
...
var handleException = e => {
 ...
 if (e instanceof WebAssembly.RuntimeError) {
  if (_emscripten_stack_get_current() <= 0) {
   err("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 1048576000)");
  }
 }
 quit_(1, e);
};
...
var ___start_em_js = Module["___start_em_js"] = 467616;

var ___stop_em_js = Module["___stop_em_js"] = 468230;
