...
// src/formats/wasm64-unknown-emscripten.cjs
var require_wasm64_unknown_emscripten = __commonJS({
  "src/formats/wasm64-unknown-emscripten.cjs"(exports2, module2) {
    var DEFAULT_GAS_LIMIT = 9e15;
    var Module = (() => {
      let _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : void 0;
      if (typeof __filename !== "undefined")
      ...
      return function(binaryOrInstantiate, { computeLimit, memoryLimit, extensions, format }) {
        ...
        var _strftime = function(s, maxsize, format2, tm) {
          s = bigintToI53Checked(s);
          ;
          maxsize = bigintToI53Checked(maxsize);
          ;
          format2 = bigintToI53Checked(format2);
          ;
        ...
        function applySignatureConversions(wasmExports2) {
          ...
          wasmExports2["emscripten_stack_get_end"] = makeWrapper_p(wasmExports2["emscripten_stack_get_end"]);
          wasmExports2["stackSave"] = makeWrapper_p(wasmExports2["stackSave"]);
          wasmExports2["stackRestore"] = makeWrapper__p(wasmExports2["stackRestore"]);
          wasmExports2["stackAlloc"] = makeWrapper_pp(wasmExports2["stackAlloc"]);
          wasmExports2["emscripten_stack_get_current"] = makeWrapper_p(wasmExports2["emscripten_stack_get_current"]);
          return wasmExports2;
        }
...
var Wasm64Emscripten = require_wasm64_unknown_emscripten();
  ...
  return (buffer, msg, env) => {
    ...
    try {
      ...
      if (msg.Tags.find((t) => t.name == "Content-Type")?.value == "application/octet-stream") {
        let uint8ArrayToBase642 = function(uint8Array) {
          const binaryString = new Uint8Array(uint8Array).reduce((acc, byte) => acc + String.fromCharCode(byte), "");
          return btoa(binaryString);
        };
        var uint8ArrayToBase64 = uint8ArrayToBase642;
        msg.Data = uint8ArrayToBase642(msg.Data);
      }
