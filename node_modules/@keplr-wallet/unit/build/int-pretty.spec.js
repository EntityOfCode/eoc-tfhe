...
describe("Test IntPretty", () => {
    ...
    it("Test sign option of IntPretty", () => {
        const tests = [
            {
                base: new int_pretty_1.IntPretty(new decimal_1.Dec("123")).sign(true),
                resStr: "+123",
            },
            {
                base: new int_pretty_1.IntPretty(new decimal_1.Dec("0")).maxDecimals(3).sign(true),
                resStr: "0.000",
            },
            {
                base: new int_pretty_1.IntPretty(new decimal_1.Dec("-0")).maxDecimals(3).sign(true),
            ...
            {
                base: new int_pretty_1.IntPretty(new decimal_1.Dec("0.1")).maxDecimals(3).sign(true),
                resStr: "+0.100",
            },
            {
                base: new int_pretty_1.IntPretty(new decimal_1.Dec("1234.123456")).maxDecimals(3).sign(true),
                resStr: "+1,234.123",
            },
            {
                base: new int_pretty_1.IntPretty(new decimal_1.Dec("0.123456"))
