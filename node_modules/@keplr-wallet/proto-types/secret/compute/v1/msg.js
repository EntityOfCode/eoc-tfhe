...
exports.protobufPackage = "secret.compute.v1";
...
exports.MsgInstantiateContract = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.senderAddress !== "") {
            writer.uint32(74).string(message.senderAddress);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.senderAddress = (_j = object.senderAddress) !== null && _j !== void 0 ? _j : "";
        return message;
    },
};
...
exports.MsgExecuteContract = {
    ...
    fromPartial(object) {
        ...
        message.senderAddress = (_g = object.senderAddress) !== null && _g !== void 0 ? _g : "";
        return message;
    },
};
