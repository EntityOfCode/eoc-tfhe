...
function findWasmBinary() {
    var f = 'test-gate-bootstrapping-nayuki-portable.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports['__cxa_is_pointer_type'] = makeWrapper__p(wasmExports['__cxa_is_pointer_type']);return wasmExports;
}
