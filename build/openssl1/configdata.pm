...
our %config = (
  ...
  makedepprog => "",
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_COMP", "OPENSSL_NO_CT", "OPENSSL_NO_MD2", "OPENSSL_NO_OCSP", "OPENSSL_NO_RC5", "OPENSSL_NO_SRP", "OPENSSL_NO_TS" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_APPS", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_ASYNC", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DSO", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_ERR", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_MSAN", "OPENSSL_NO_PSK", "OPENSSL_NO_RFC3779", "OPENSSL_NO_SCTP", "OPENSSL_NO_SRTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_STDIO", "OPENSSL_NO_TESTS", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => " no-afalgeng no-apps no-asan no-asm no-async no-buildtest-c++ no-capieng no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-ct no-devcryptoeng no-dso no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-err no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-makedepend no-md2 no-msan no-ocsp no-psk no-rc5 no-rfc3779 no-sctp no-shared no-srp no-srtp no-ssl-trace no-ssl3 no-ssl3-method no-stdio no-tests no-ts no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "no-asm", "no-shared", "no-async", "no-dso", "no-hw", "no-engine", "no-stdio", "no-tests", "no-ssl", "no-comp", "no-err", "no-ocsp", "no-psk", "no-srp", "no-ts", "no-rfc3779", "no-srtp", "no-weak-ssl-ciphers", "no-ssl-trace", "no-ct", "linux-aarch64" ],
  perlenv => {
      "AR" => "/emsdk/upstream/emscripten/emar",
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "idea", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ui", "cms", "cmac", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
